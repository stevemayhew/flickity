...
proto.select = function( index, isWrap, isInstant, offset ) {
  ...
  this.dispatchEvent('select', null, [ prevSelectedIndex ]);
...
proto._prevNextStepBy = function( direction, isWrap ) {
 ...
 */
proto.cellVisibility = function( cellIndex ) {
  var value = false;
  var cell = this.cells[ cellIndex ];
  var cellViewportX;
 ...
 * @returns {Array} cells - array of Flickity.Cells
 */
proto.getVisibleCellElements = function( extraCount ) {
